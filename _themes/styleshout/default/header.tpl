    <div id="header"><div id="header-content">
        ...
        <h2 id="slogan">Ph.D Candidate, <a target="_new" href="http://www.ucsd.edu/">UC San Diego</a> <a target="new" href="http://www.cogsci.ucsd.edu/">Cognitive Science</a></h2>
      ...
      <!-- Menu Tabs -->
        <ul>
            ...
            <li><a href="projects.php"     {if $pageinfo.pagename=='projects'    } id="current"{/if}>Projects</a></li>
